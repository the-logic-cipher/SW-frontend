      ...
      <div className="p-head py-5">
        <div className="container text-center">
          <div className=" d-flex justify-content-center">
            ...
            <div className="bar"></div>
            <h6>
              <Link to="/payment" className="mb-0 text-black fw-bold">
                <span className="counts fs-5 fw-bold text-white">
                  <DoneIcon sx={{ marginTop: -0.5 }} />
                </span>{" "}
                Payment{" "}
          ...
          <div className="col-lg-6 col-md-8">
            <div className="cart p-5 px-sm-5 px-4">
              <img
                ...
                alt="done"
              />
              <h3 className="fs-3 fw-bold text-center text-black">
                Your Order <br /> Has Been Placed
              </h3>
              <h6 className="fs-6 text-center mt-4 text-black">
                If you have any query kindly contact us at
                the.logic.cipher@gmail.com{" "}
              </h6>
              <h6 className="fs-5 fw-bold text-center mt-4 text-black">
